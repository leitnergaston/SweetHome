...
public class Main2 {
    ...
    public static void main(String[] args) {
        ...
        Propietario propietario = new Propietario(1, 456, "sanchez", "mariana", "calle 455", "26151145", "marisanchez@mail.com", true);
        ...
        ArrayList<Inmueble> listaInm =  inmData.listarInmueblesPorParametros("casa", 300, 10000, 1000000,  "centro");
